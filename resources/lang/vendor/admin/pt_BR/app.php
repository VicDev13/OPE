...
return [
    ...
    'acl' => [
        ...
        'create' => 'Adicionar',
        'delete' => 'Deletar',
        'mass-delete' => 'Deletar vários',
        'mass-update' => 'Editar vários',
        'marketing' => 'Marketing',
        'promotions' => 'Promoções',
    ...
    'sales' => [
        'orders' => [
            ...
            'item-refunded' => 'Devolvido(s) (:qty_refunded)',
            'price' => 'Preço',
            'total' => 'Total',
            'subtotal' => 'Subtotal',
        ...
        'refunds' => [
            ...
            'invalid-refund-amount-error' => 'O valor do reembolso não deve ser zero.'
    ...
    'catalog' => [
        'products' => [
            ...
            'is-default' => 'Padrão',
            'remove-image-btn-title' => 'Remover Imagem',
            'videos' => 'Videos',
            'video' => 'Video',
            'add-video-btn-title' => 'Add Video',
            'remove-video-btn-title' => 'Remover Video',
            'not-support-video' => 'Seu navegador não suporta a tag de vídeo.',
        ],
    ...
    'marketing' => [
        'templates' => [
            ...
            'add-title' => 'Add Modelos de Email',
            'edit-title' => 'Editar Modelos de Email',
            'save-btn-title' => 'Salvar',
            'general' => 'Geral',
            'name' => 'Nome',
            'status' => 'Status',
        ...
        'campaigns' => [
            'title' => 'Campanhas',
            'add-title' => 'Add Campanhas',
            'edit-title' => 'Editar Campanhas',
            'save-btn-title' => 'Salvar',
            'general' => 'Geral',
            'name' => 'Nome',
            'status' => 'Status',
            ...
            'inactive' => 'Inativo',
            'subject' => 'Subject',
            'email-template' => 'Modelos de Email',
            'audience' => 'Público',
            'channel' => 'Canal',
    ...
    'admin' => [
        ...
        'system' => [
            'catalog' => 'Catálogo',
            'homepage' => 'Configuração da página inicial',
