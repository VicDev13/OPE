...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/x-template" id="variant-form-template">
        <form method="POST" action="<?php echo e(route('admin.catalog.products.store')); ?>"
            ...
            <table>
                ...
                <tr>
                    ...
                    <?php $__currentLoopData = $product->super_attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <th class="<?php echo e($attribute->code); ?>"
                            style="width: 150px"><?php echo e($attribute->admin_name); ?></th>
            ...
            <td>
                <div class="control-group"
                    ...
                    <input type="text" v-validate="'required'" v-model="variant.sku"
                           ...
                           data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.sku')); ?>&quot;"
                           v-slugify/>
            ...
            <td>
                <div class="control-group"
                    ...
                    <input type="text" v-validate="'required'" v-model="variant.name"
                           ...
                           data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.name')); ?>&quot;"/>
            ...
            <td>
                <div class="control-group"
                    ...
                    <input type="number" v-validate="'required'" v-model="variant.price"
                           ...
                           data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.price')); ?>&quot;"
                           step="any"/>
            ...
            <td>
                <div class="control-group"
                    ...
                    <input type="number" v-validate="'required'" v-model="variant.weight"
                           ...
                           data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.weight')); ?>&quot;"
                           step="any"/>
            ...
            <td>
                <div class="control-group">
                    <select type="text" v-model="variant.status"
                        ...
                        <option value="1"
                                :selected="variant.status"><?php echo e(__('admin::app.catalog.products.enabled')); ?></option>
                        <option value="0"
                                :selected="!variant.status"><?php echo e(__('admin::app.catalog.products.disabled')); ?></option>
                    </select>
                </div>
            </td>

            <td class="actions">
                <a :href="['<?php echo e(route('admin.catalog.products.index')); ?>/edit/' + variant.id]"><i
                        ...
                        if (result) {
                            ...
                            if (filteredVariants.length) {
                                ...
                                window.flashMessages = [{
                                    'type': 'alert-error',
                                    'message': "<?php echo e(__('admin::app.catalog.products.variant-already-exist-message')); ?>"
                                }];
        ...
        Vue.component('variant-list', {
            ...
            data: function () {
                return {
                    ...
                    old_variants: <?php echo json_encode(old('variants'), 15, 512) ?>,
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\xokit\OneDrive\Documentos\Jarvis_Mind\Faculdade\OPE\packages\Webkul\Admin\src/resources/views/catalog/products/accordians/variations.blade.php ENDPATH**/ ?>