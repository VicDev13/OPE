<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('admin::app.catalog.families.add-title')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="content">
        <form method="POST" action="<?php echo e(route('admin.catalog.families.store')); ?>" @submit.prevent="onSubmit">

            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="window.location = '<?php echo e(route('admin.catalog.families.index')); ?>'"></i>
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.general.before'); ?>


                    <accordian :title="'<?php echo e(__('admin::app.catalog.families.general')); ?>'" :active="true">
                        <div slot="body">

                            <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.general.controls.before'); ?>


                            <div class="control-group" :class="[errors.has('code') ? 'has-error' : '']">
                                <label for="code" class="required"><?php echo e(__('admin::app.catalog.families.code')); ?></label>
                                <input type="text" v-validate="'required'" class="control" id="code" name="code" value="<?php echo e(old('code')); ?>" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.families.code')); ?>&quot;" v-code/>
                                <span class="control-error" v-if="errors.has('code')">{{ errors.first('code') }}</span>
                            </div>

                            <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                <label for="name" class="required"><?php echo e(__('admin::app.catalog.families.name')); ?></label>
                                <input type="text" v-validate="'required'" class="control" id="name" name="name" value="<?php echo e(old('name')); ?>" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.families.name')); ?>&quot;"/>
                                <span class="control-error" v-if="errors.has('name')">{{ errors.first('name') }}</span>
                            </div>

                            <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.general.controls.after'); ?>


                        </div>
                    </accordian>

                    <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.general.after'); ?>



                    <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.groups.before'); ?>
                    ...
                    <accordian :title="'<?php echo e(__('admin::app.catalog.families.groups')); ?>'" :active="true">
                        <div slot="body">
                            ...
                            <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.groups.controls.before'); ?>


                            <group-list></group-list>

                            <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.groups.controls.after'); ?>

                        </div>
                    </accordian>

                    <?php echo view_render_event('bagisto.admin.catalog.family.create_form_accordian.groups.after'); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        var groups = <?php echo json_encode($attributeFamily ? $attributeFamily->attribute_groups : [], 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xokit\OneDrive\Documentos\Jarvis_Mind\Faculdade\OPE\packages\Webkul\Admin\src/resources/views/catalog/families/create.blade.php ENDPATH**/ ?>