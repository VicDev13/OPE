                            ...
                            <div class="row">
                                ...
                                <div class="right col-lg-7 col-md-6">
                                    ...
                                    <div class="row info">
                                        ...
                                        <?php if(count($product->getTypeInstance()->getCustomerGroupPricingOffers()) > 0): ?>
                                            <div class="col-12">
                                                <?php $__currentLoopData = $product->getTypeInstance()->getCustomerGroupPricingOffers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo e($offers); ?> </br>
            ...
            <div class="store-meta-images col-3">
                <?php if(
                    ...
                    <?php $__currentLoopData = json_decode($velocityMetaData['product_view_images'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($image && $image !== ''): ?>
                            <img src="<?php echo e(url()->to('/')); ?>/storage/<?php echo e($image); ?>" alt=""/>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xokit\OneDrive\Documentos\Jarvis_Mind\Faculdade\OPE/resources/themes/velocity/views/products/view.blade.php ENDPATH**/ ?>