...
<?php echo view_render_event('bagisto.shop.products.view.gallery.before', ['product' => $product]); ?>
    ...
    <div class="product-image-group">
        <div class="row col-12">
            <magnify-image src="<?php echo e($images[0]['large_image_url']); ?>" type="<?php echo e($images[0]['type']); ?>">
            </magnify-image>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\xokit\OneDrive\Documentos\Jarvis_Mind\Faculdade\OPE/resources/themes/velocity/views/products/view/gallery.blade.php ENDPATH**/ ?>